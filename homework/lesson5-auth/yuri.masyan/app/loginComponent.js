...
angular.module('app').component('loginComponent', {
  controller: function(authService, $scope){
    this.login = function(username, password){
      authService.loginByCredentials(username, password);
/*
      authService.loginByCredentials(username, password).catch(function(){
...
<div class="col-md-6 col-md-offset-3">
    <h2>Login 'admin/password'</h2>
    <form name="form" ng-submit="$ctrl.login($ctrl.username,$ctrl.password)" role="form">
